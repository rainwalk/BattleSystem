...
이 프로젝트는 이러한 문제점들의 발생을 최소화하는 데 초점을 맞췄습니다. 핵심은 **스킬의 확장성과 재사용성**을 최우선으로 고려한 설계입니다. 기존에 만들어진 다양한 이펙트를 모듈화하고, 이를 조합하여 각 스킬에 독립적으로 추가 및 수정할 수 있는 구조로 만들었습니다. 이를 통해 스킬 시스템의 유지보수성과 확장성을 높이고, 새로운 스킬 추가 및 수정 작업이 효율적이고 직관적으로 이루어질 수 있도록 했습니다.
